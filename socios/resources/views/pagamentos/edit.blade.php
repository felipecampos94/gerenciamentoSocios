        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                {!! Form::select('socio_id',
                                ...
                                $pagamento->socio_id, ['class'=>'form-control', 'disabled']) !!}
            </div>
            ...
            <div class="form-group">
                ...
                {!! Form::text('anoReferencia', $pagamento->anoReferencia, ['class'=>'form-control', 'require']) !!}
            </div>


            <div class="form-group">
                {!! Form::label('valorTotal', 'Valor Total:') !!}
                {!! Form::number('valorTotal',$pagamento->valorTotal, ['class'=>'form-control','required']) !!}
            </div>
            ...
            <div class="form-group">
                {!! Form::submit('Editar Pagamento', ['class'=>'btn btn-primary']) !!}
            </div>
