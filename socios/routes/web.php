...
Route::group(['prefix' => 'ctgs', 'where' => ['id' => '[0-9]+']], function () {
        ...
        Route::get('edit',    ['as' => 'ctgs.edit',    'uses' => 'CtgsController@edit']);
...
Route::group(['prefix' => 'dependentes', 'where' => ['id' => '[0-9]+']], function () {
        ...
        Route::get('edit',    ['as' => 'dependentes.edit', 'uses'    => 'DependentesController@edit']);
...
Route::group(['prefix' => 'formas', 'where' => ['id' => '[0-9]+']], function () {
        ...
        Route::get('edit',    ['as' => 'formas.edit',    'uses' => 'FormasController@edit']);
...
Route::group(['prefix' => 'socios', 'where' => ['id' => '[0-9]+']], function () {
        ...
        Route::get('edit',    ['as' => 'socios.edit',    'uses' => 'SociosController@edit']);
    ...
    Route::group(['prefix' => 'pagamentos', 'where' => ['id' => '[0-9]+']], function () {
        ...
        Route::get('edit', ['as' => 'pagamentos.edit', 'uses' => 'PagamentosController@edit']);
